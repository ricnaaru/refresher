...
import 'package:refresher/infinite_list_view_builder.dart';
...
class InfiniteRefresherBuilder extends StatefulWidget {
  ...
  @override
  _InfiniteRefresherBuilderState createState() =>
      _InfiniteRefresherBuilderState();
}

class _InfiniteRefresherBuilderState extends State<InfiniteRefresherBuilder>
...
//    });
  ...
  @override
  void didUpdateWidget(InfiniteRefresherBuilder oldWidget) {
                ...
                child: GestureDetector(
                  child: NotificationListener<ScrollNotification>(
                    ...
                    child: InfiniteListViewBuilder(
                      ...
                      dividerHeight: widget.dividerHeight ?? 0,
